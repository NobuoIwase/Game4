...
/* ---------------- ヒロインの武器/パッシブ ---------------- */
const UPG={
  bolt:  {name:'ホーリーボルト',   d1:'ひかりの矢で',    d2:'じどうこうげき',  max:10, kind:'wp'},
  orb:   {name:'セイントオーブ',   d1:'まもりの光球が',  d2:'まわりをかいてん', max:10, kind:'wp'},
  nova:  {name:'ピュアノヴァ',     d1:'じょうかの波動で', d2:'まわりをいっそう', max:10, kind:'wp'},
  whip:  {name:'プリズムウィップ', d1:'ひかりのムチが',  d2:'まえをなぎはらう', max:10, kind:'wp'},
  rain:  {name:'スターレイン',     d1:'ながれ星が',      d2:'ふりそそぐ',      max:10, kind:'wp'},
  cross: {name:'クロスブーメラン', d1:'ひかりの十字が',  d2:'いって、もどる',  max:10, kind:'wp'},
  sanct: {name:'せいいき',         d1:'まわりの光が',    d2:'ふれた敵をやく',  max:10, kind:'wp'},
  blade: {name:'ひかりの刃',       d1:'むいた方向へ',    d2:'刃をとばす',      max:10, kind:'wp'},
  thunder:{name:'てんらい',        d1:'いかずちが',      d2:'ランダムにおちる', max:10, kind:'wp'},
  holy:  {name:'せいすい',         d1:'なげた聖水が',    d2:'地面をきよめる',  max:10, kind:'wp'},
  speed: {name:'スピードシューズ', d1:'いどう速度',      d2:'+10%',            max:5, kind:'ps'},
  vital: {name:'マックスハート',   d1:'さいだいHP+25',   d2:'いまも回復する',   max:6, kind:'ps'},
  magnet:{name:'ジェムマグネット', d1:'ジェムの回収',    d2:'はんいUP',        max:4, kind:'ps'},
  haste: {name:'クイックリボン',   d1:'こうげき速度',    d2:'+8%',             max:5, kind:'ps'},
  ward:  {name:'プチバリア',       d1:'まもり',          d2:'+1',              max:4, kind:'ps'},
  ...
  luck:  {name:'よつばのクローバー', d1:'燭台のアイテム', d2:'でやすく',        max:4, kind:'ps'},
