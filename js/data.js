...
const BAL={
  ...
  /* v6.7 居た場所で数え直すと、巣窟は「時間の 6.3% で発情の 30.5%」——
     毎秒 25.1 対 外 3.9 で 6.4倍。作者の「えちえちエリアが強すぎる」は当たっていた。
     ★以前の「巣窟の仕掛けは発情の 0.1%」は denTick が湧かせた雲だけを数えた狭い見方で、
       床の手・陣・沼・番人・奥の一撃が抜け落ちていた。
     外との比は 5倍前後を残しつつ(危ない場所であることは変えない)、20%ほど薄くする */
  DEN_POW0:0.46,       /* 積もり(毎秒の火照り/敏感化・床の手・陣): 1階でも通れば効く */
  DEN_POW_K:0.042,     /* 一階ごとに足す分。15階で 1.05 */
  DEN_POW_MAX:1.10,
  ...
  PARTY_LEASH:620, PARTY_MAXDX:740, PARTY_MAXDY:360, PARTY_SEP:96, PARTY_SEP_K:0.85, RESCUE_R:60, RESCUE_T:3.0, RESCUE_GRAB_K:0.5, TALK_T:1.3, ASSIST_R:120, HEART_YIELD:0.15, PARTY_HOLD:7, PARTY_TALK_CD:10,   // v5.0 くっつきすぎない: 寄る力は 620px から / 96px より近いと離れる
