...
- **文章の器**: `js/lines_party.js`(LINES_P)、`js/lines_freila.js`(LINES_F)、`js/scenes_freila.js`(SCENES_F)、`js/story_v30.js`(STORY_V30)。仕様は `docs/TEXT_SPEC_v30.md`。取り込み時に禁止語尾・NG語・♡の位置を機械検査(問題0件)。
