...
### 3-3. 魅了(v0.4で対象別・レベル制に)

**魅了は「どの個体に」惚れているかを個別に持つ**。ナメクジ接触(個体CD6s)でその個体への段階が上がる。持続16s(重ねがけで更新、切れると1段降下)。

| Lv | 機構 |
|---|---|
| Ⅰ | その個体への**与ダメ-25%**・狙い後回し・脅威認識低下 |
| Ⅱ | -50%。加えて**発作**: 6.5sごとに約2.4s、無意識にその個体へ歩み寄ってしまう |
| Ⅲ | -75%。発作中にその個体へ触れると**魅了拘束**——自分から縋りつく特殊拘束。移動攻撃不能・被ダメ×1.3・快感+5/s・0.9sごとスタミナ-4/正気+15。正気100で我に返り振りほどく(その個体への魅了は消滅)。**スタミナ0で敗北(敗因: 魅了)** |

- 対象が死ぬと魅了は消える(Lv2以上なら我に返る台詞)
...
- 基礎: HP120 / スタミナ100 / 護り5 / 回復0.55/s / 速度150。**世代内戦歴nで** HP+18%n・護り+n・回復+0.15n・初期装備追加
